...
//获取任务列表
    private void requestTask(String waveHouseID,int shopID) {
        ...
        pDialog.show();
        AsyncHttpPost.post(mContext, WebAPI.JHXJ_PARENT, JsonCreate.requestPick(ShareUtil.getInstance(mContext).getareaCode(),waveHouseID,"", ShareUtil.getInstance(mContext).getWaveHouse(),shopID), new AsyncHttpPost.Postinterface() {
